...
| 能力 | 接口 | 方法 | API ID |
|------|------|------|--------|
| 车次查询 | `POST https://app-cp9yn7w7fuo1-api-DLEO73l7Vjwa-gateway.appmiaoda.com/train/line` | POST | `api-DLEO73l7Vjwa` |
| 余票查询 | `POST https://app-cp9yn7w7fuo1-api-DLEO73lBPZ2a-gateway.appmiaoda.com/train/ticket` | POST | `api-DLEO73lBPZ2a` |
| 站站查询 | `POST https://app-cp9yn7w7fuo1-api-V9PworyO6gEa-gateway.appmiaoda.com/train/station2s` | POST | `api-V9PworyO6gEa` |
...
const response = await fetch("https://<api_id>@app-cp9yn7w7fuo1-api-DLEO73l7Vjwa-gateway.appmiaoda.com<path>?<params>", {
  method: "POST",
  headers: {
