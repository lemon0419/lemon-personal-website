...
| Endpoint | `POST https://app-cp9yn7w7fuo1-api-2Y00V8pRRoxY-gateway.appmiaoda.com/caipiao/winning` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-cp9yn7w7fuo1-api-2Y00V8pRRoxY-gateway.appmiaoda.com` |
...
async function queryCaipiaoWinning(
  ...
  const url =
    `https://app-cp9yn7w7fuo1-api-2Y00V8pRRoxY-gateway.appmiaoda.com/caipiao/winning?${params.toString()}`;
