...
| Endpoint | `POST https://app-cp9yn7w7fuo1-api-baBw2m51JXz9-gateway.appmiaoda.com/caipiao/query` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-cp9yn7w7fuo1-api-baBw2m51JXz9-gateway.appmiaoda.com` |
...
async function queryCaipiaoResult(
  ...
  const url =
    `https://app-cp9yn7w7fuo1-api-baBw2m51JXz9-gateway.appmiaoda.com/caipiao/query?${params.toString()}`;
