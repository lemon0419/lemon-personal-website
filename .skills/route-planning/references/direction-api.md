...
| third_part_domain | `app-cp9yn7w7fuo1-api-GaDwZKpJxXOY-gateway.appmiaoda.com` |

| 接口 | API ID | Endpoint |
|------|--------|---------|
| 驾车路线规划 | `api-GaDwZKpJxXOY` | `GET https://app-cp9yn7w7fuo1-api-GaDwZKpJxXOY-gateway.appmiaoda.com/direction/v2/driving` |
| 骑行路线规划 | `api-W9z3MpAdKeNL` | `GET https://app-cp9yn7w7fuo1-api-W9z3MpAdKeNL-gateway.appmiaoda.com/direction/v2/riding` |
| 步行路线规划 | `api-wLNdomNRn42a` | `GET https://app-cp9yn7w7fuo1-api-wLNdomNRn42a-gateway.appmiaoda.com/direction/v2/walking` |
| 公交路线规划 | `api-m9xKXQkOKZXa` | `GET https://app-cp9yn7w7fuo1-api-m9xKXQkOKZXa-gateway.appmiaoda.com/direction/v2/transit` |
...
async function planRoute(
  ...
  const url = `https://${apiId}@app-cp9yn7w7fuo1-api-GaDwZKpJxXOY-gateway.appmiaoda.com/direction/v2/${mode}?${params.toString()}`;
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl =
    `https://${apiId}@app-cp9yn7w7fuo1-api-GaDwZKpJxXOY-gateway.appmiaoda.com/direction/v2/${mode}?${params.toString()}`;
