...
- **Endpoint**：`POST https://app-cp9yn7w7fuo1-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-cp9yn7w7fuo1-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
