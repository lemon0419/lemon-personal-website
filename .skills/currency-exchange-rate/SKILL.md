...
- **Endpoint**: `POST https://app-cp9yn7w7fuo1-api-ELbWz8OmBW5Y-gateway.appmiaoda.com/exchange-rate-v2/single`
...
async function getExchangeRates(fromCode: string): Promise<ExchangeRateData> {
  const response = await fetch(
    "https://app-cp9yn7w7fuo1-api-ELbWz8OmBW5Y-gateway.appmiaoda.com/exchange-rate-v2/single",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
