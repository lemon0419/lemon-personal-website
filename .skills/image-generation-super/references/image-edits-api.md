...
| Endpoint | `POST http://app-cp9yn7w7fuo1-api-baBw3XMNVmv9-gateway.appmiaoda.com/v1/images/edits` |
...
async function editImage(params: EditImageParams): Promise<EditImageResult> {
  ...
  const response = await fetch(
    "http://app-cp9yn7w7fuo1-api-baBw3XMNVmv9-gateway.appmiaoda.com/v1/images/edits",
    {
      method: "POST",
      headers: {
