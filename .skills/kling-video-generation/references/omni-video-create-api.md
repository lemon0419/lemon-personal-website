...
| Endpoint | `POST https://app-cp9yn7w7fuo1-api-oLpZb03wbNBa-gateway.appmiaoda.com/v1/videos/omni-video` |
| Auth 模式 | `platform_managed`（`traefik: true`） |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| third_part_domain | `app-cp9yn7w7fuo1-api-oLpZb03wbNBa-gateway.appmiaoda.com` |
