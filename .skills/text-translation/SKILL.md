...
- **Endpoint**: `POST https://app-cp9yn7w7fuo1-api-e94GZ5j0PWpa-gateway.appmiaoda.com/rpc/2.0/mt/texttrans/v1`
...
async function translateText(
  ...
  const response = await fetch(
    "https://app-cp9yn7w7fuo1-api-e94GZ5j0PWpa-gateway.appmiaoda.com/rpc/2.0/mt/texttrans/v1",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json;charset=utf-8",
