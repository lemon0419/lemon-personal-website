...
- **Endpoint**: `GET https://app-cp9yn7w7fuo1-api-qYGWoqjEmMnY-gateway.appmiaoda.com/v2/tools/trending_lists/medium`
...
async function queryTrendingList(type: number): Promise<TrendingItem[]> {
  const url = new URL(
    "https://app-cp9yn7w7fuo1-api-qYGWoqjEmMnY-gateway.appmiaoda.com/v2/tools/trending_lists/medium"
  );
